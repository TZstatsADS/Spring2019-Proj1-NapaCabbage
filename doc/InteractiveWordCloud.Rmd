...
```{r }
##folder.path = "../output/"
speeches = read.csv("C:\\Users\\ZONGBO CAI\\Google ‘∆∂À”≤≈Ã\\Columbia\\GR5243 SPRING\\Spring2019-Proj1-NapaCabbage\\output\\processed_moments.csv")
```
...
wordcloud(hm_data$cleaned_hm, tdm.overall$`sum(count)`,
          scale=c(5,0.5),
          max.words=100,
          min.freq=1,
          random.order=FALSE,
